...
let{"first-name": firstName} = person; // nikal hum person se first-name ko firstName variable me store karna chahte hai to colon ke baad jo bhi name hoga wo name variable ko dediya jayega
console.log(firstName); // Output: Alice
